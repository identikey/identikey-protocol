...
| [`identikey-capability`](crates/identikey-capability) | Agency capability tokens: Biscuit mint/verify, Ed25519 authority, holder checks (never `holder` facts). Wire + validators, no lifecycle. Spec [`identikey-capability-v1.md`](docs/standards/identikey-capability-v1.md). |
