...
**Status:** Spec  
**Date:** 2026-04-21  
**Scope:** Identity envelope serialization interop between Rust (`bc-envelope` 0.43.0) and Zig (hand-rolled dCBOR reader). Applies to any Gordian Envelope this workspace emits — wallet containers and `identikey-auth` challenge/response alike.  
