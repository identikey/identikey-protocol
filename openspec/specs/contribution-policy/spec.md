...
Folded from `add-protocol-dco` on 2026-09-24.

## Purpose

Accept identikey-protocol contributions with a Developer Certificate
of Origin. Do not require a CLA for this repository. Inbound license
stays Apache-2.0 OR BSD-2-Clause-Patent. Vendor trees keep their own
upstream contributor terms.
