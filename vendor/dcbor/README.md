...
### 0.25.2 - March 16, 2026
- Add numeric reduction example demonstrating integer/float extraction and dCBOR canonical encoding rules.

### 0.25.1 - January 31, 2026
- Add expected-text-output-rubric comments to test files.
